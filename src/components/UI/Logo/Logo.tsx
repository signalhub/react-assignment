...
const Logo: React.FC = () => {
  return (
    <div className='Logo'>
      <a href={'https://paxful.com/'} target={'blank'} className="brand-logo">
        <svg enableBackground="new 0 0 123.7 23.3" viewBox="0 0 123.7 23.3" xmlns="http://www.w3.org/2000/svg"
             className="c-header__logoImg" fill="#333" data-darkreader-inline-fill="">
          <path
          ...
          <path d="m63.1 0-21.6 23.2c-.2.3-.7-.1-.4-.4l15.6-22c.4-.5 1-.8 1.7-.8z" fill="#00a5ef"
